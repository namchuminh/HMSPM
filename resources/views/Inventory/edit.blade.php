        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" method="POST" action="{{ route('inventory.update', $inventory->id) }}">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <!-- Cột trái -->
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="expiration_date" value="{{ $inventory->expiration_date }}">
                            ...
                            <div class="text-right mt-3">
                                ...
                                <button class="btn btn-warning" >In Phiếu Nhập</button>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Trạng Thái:</strong> <span id="preview_status">{{ $inventory->status == 'new' ? 'Mới' : 'Đã qua sử dụng' }}</span></p>
                        ...
                        <p><strong>Người Nhập:</strong> <span id="preview_quantity">{{ $inventory->user->name }}</span></p>
